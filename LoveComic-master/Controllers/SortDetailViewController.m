...
@property (nonatomic,copy)  NSString *theSortKey;

@property (nonatomic,copy)  NSString *theSortValue;
...
-(void)requseData{
    ...
    NSString *link=[NSString stringWithFormat:SortDetailURL,self.theSortKey,self.pageNumber,self.orderByStr];
    //转UTF-8
